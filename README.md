...
Our data are updated with a one-day lag. This means that the most recent data in today's update are from the previous day. This lag is due to standard delays in reporting a new test or case to the Health Department and are a common limitation of surveillance data. Counts of what has happened in the most recent days are artificially small. 
